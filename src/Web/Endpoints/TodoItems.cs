using AcademyCleanTesting.Application.Common.Models;
using AcademyCleanTesting.Application.TodoItems.Commands.CreateTodoItem;
using AcademyCleanTesting.Application.TodoItems.Commands.DeleteTodoItem;
using AcademyCleanTesting.Application.TodoItems.Commands.UpdateTodoItem;
using AcademyCleanTesting.Application.TodoItems.Commands.UpdateTodoItemDetail;
using AcademyCleanTesting.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace AcademyCleanTesting.Web.Endpoints;
